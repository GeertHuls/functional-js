...
var max = _.reduce(greater, Number.NEGATIVE_INFINITY);
...
////////////////////////////////////////////
//Implement map/reduce in javascript:
...
//newmap might not work (untested)


var newmap2 = _.curry(function (f, list) {
  var concatList = function (acc, elt) {
    return acc.concat([f(elt)]);
  };
